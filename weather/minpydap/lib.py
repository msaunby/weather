...
from minpydap.exceptions import ConstraintExpressionError


__author__  = 'Roberto De Almeida <rob@pydap.org>'
__version__ = (3,0,1)       # pydap version
...
def parse_qs(query):
    ...
    """
    projection = []
    selection = [urllib.unquote(token) for token in query.split('&') if token]
